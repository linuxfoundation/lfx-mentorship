...
type mentorship_program
  relations
    ...
    # program_approver is included here so an approver can read a pending program
    # (no public wildcard yet) in order to review it — but not manage it.
