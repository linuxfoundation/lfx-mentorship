...
export const lfxHeaderCtas: HeaderCtaItem[] = [
  { label: 'Enroll a Program', to: AppRoute.SelfServeAdmin, type: 'outline' },
  { label: 'Become a Mentor', to: AppRoute.SelfServeMentor, type: 'outline' },
  { label: 'My Mentorship', to: AppRoute.MyMentorship, type: 'primary' },
];
