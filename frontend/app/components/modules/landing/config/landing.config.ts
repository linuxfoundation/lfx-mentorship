...
import { PROGRAM_STATUS_CONFIG } from '~/components/modules/programs/config/program-card.config';
import type {
  LandingBenefit,
...
export const LANDING_TERMS: LandingTerm[] = [
  {
    id: 'term-1',
    name: 'Term 1',
    dateRangeLabel: 'Mar 1 – May 24, 2026',
    applicationsLabel: 'Applications closed Jan 15',
    status: 'completed',
  },
  {
    id: 'term-2',
    ...
    applicationsLabel: 'Applications closed Apr 15',
    status: 'in-progress',
  },
  {
    id: 'term-3',
    name: 'Term 3',
    dateRangeLabel: 'Sep 1 – Nov 23, 2026',
    applicationsLabel: 'Applications open until Jul 15',
    status: 'acceptance',
  },
];

export const LANDING_TERMS_FOOTER =
  'Every term runs 12 weeks. You may hold one active mentorship at a time and submit up to three applications per term.';
...
export const LANDING_PROGRAMS_PREVIEW_COUNT = 3;

export const LANDING_TERM_STATUS_CONFIG = PROGRAM_STATUS_CONFIG;
